...
export async function getUserProfile(access_token: string, user_id: string) {
...
export async function getOAProfile(access_token: string) {
...
export async function getFollowers(access_token: string, offset = 0, count = 50, tag_name?: string) {
